...
import it.gov.pagopa.apiconfig.datamigration.model.AppInfo;
import it.gov.pagopa.apiconfig.datamigration.model.ProblemJson;
import it.gov.pagopa.apiconfig.datamigration.service.HealthCheckService;
...
public class HomeController {
    ...
    public ResponseEntity<AppInfo> healthCheck() {
        AppInfo info = AppInfo.builder()
                ...
                .oracleDBStatus(healthCheckService.getHealthCheckForOracleDB() ? "up" : "down")
                .postgresDBStatus(healthCheckService.getHealthCheckForPostgresDB()  ? "up" : "down")
                .build();
