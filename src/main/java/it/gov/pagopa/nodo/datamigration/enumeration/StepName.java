...
public enum StepName {
    ...
    EXECUTE_IBAN_TABLE_MIGRATION,
    EXECUTE_IBAN_ATTRIBUTES_TABLE_MIGRATION,
    EXECUTE_IBAN_MASTER_TABLE_MIGRATION,
    EXECUTE_IBAN_ATTRIBUTES_MASTER_TABLE_MIGRATION,
    EXECUTE_ICA_BINARY_FILE_TABLE_MIGRATION,
