...
class ExecuteGDEConfigTableMigrationStepTest {
    ...
    void testExecuteStep() throws MigrationStepException, IllegalAccessException, NoSuchFieldException {
        ...
        // Emulating findAll
        Field field = ExecuteGDEConfigTableMigrationStep.class.getDeclaredField("PAGE_SIZE");
    ...
    void getNextState() {
        ...
        assert nextState == StepName.END;
    }

    @Test
    void getStepName() {
        String stepName = migrationStep.getStepName();
        assert stepName.equals("EXECUTE_GDE_CONFIG_TABLE_MIGRATION");
    }
}
