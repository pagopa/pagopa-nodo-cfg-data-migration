...
class ExecuteCodifichePATableMigrationStepTest {
    ...
    void testExecuteStep() throws MigrationStepException, IllegalAccessException, NoSuchFieldException {
        ...
        // Emulating findAll
        Field field = ExecuteCodifichePATableMigrationStep.class.getDeclaredField("PAGE_SIZE");
    ...
    void getNextState() {
        ...
        assert nextState == StepName.EXECUTE_BINARY_FILE_TABLE_MIGRATION;
    }

    @Test
    void getStepName() {
        String stepName = migrationStep.getStepName();
        assert stepName.equals("EXECUTE_CODIFICHE_PA_TABLE_MIGRATION");
    }
}
