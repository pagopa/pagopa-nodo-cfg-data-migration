...
class ExecuteInformativeContoAccreditoMasterTableMigrationStepTest {
    ...
    void testExecuteStep() throws MigrationStepException, IllegalAccessException, NoSuchFieldException {
        ...
        // Emulating findAll
        Field field = ExecuteInformativeContoAccreditoMasterTableMigrationStep.class.getDeclaredField("PAGE_SIZE");
    ...
    void getNextState() {
        ...
        assert nextState == StepName.EXECUTE_INFORMATIVE_CONTO_ACCREDITO_DETAIL_TABLE_MIGRATION;
    }

    @Test
    void getStepName() {
        String stepName = migrationStep.getStepName();
        assert stepName.equals("EXECUTE_INFORMATIVE_CONTO_ACCREDITO_MASTER_TABLE_MIGRATION");
    }
}
